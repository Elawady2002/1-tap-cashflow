        ...
        >
            ...
            <section className="flex flex-col gap-8">
                ...
                <div className="grid grid-cols-1 xl:grid-cols-12 gap-10">
                    ...
                    <div className="card-base xl:col-span-7 flex flex-col gap-10 p-8 shadow-2xl bg-surface/30 backdrop-blur-md">
                        <div className="flex items-center justify-between border-b border-border-dim/30 pb-6">
                        ...
                        <div className="flex flex-col gap-8">
                            <div className="flex flex-col gap-3">
                                <span className={clsx("text-6xl font-black leading-none tracking-tighter transition-colors duration-1000", getActivityColor(analysis?.level || ''))}>
                    ...
                    <div className="card-base xl:col-span-5 bg-brand-tint/10 border-accent/20 flex flex-col gap-10 p-8 shadow-2xl relative overflow-hidden">
                        <div className="absolute top-0 right-0 w-64 h-64 bg-accent/5 blur-[100px] -mr-32 -mt-32" />

                        <div className="flex items-center gap-4 border-b border-accent/20 pb-6 relative z-10">
                            <Target size={28} className="text-accent" />
                            <h3 className="text-2xl font-black tracking-tight">Audience Pain Points</h3>
                        </div>

                        <div className="bg-page/40 rounded-[2.5rem] p-8 border border-accent/10 relative overflow-hidden flex-1 shadow-inner group flex items-center justify-center min-h-[300px]">
                            <Info size={48} className="absolute top-10 right-10 text-accent/5 group-hover:text-accent/20 transition-all duration-700" />
                            <div className="text-text-secondary text-xl leading-[1.6] italic whitespace-pre-line font-medium text-center px-4 relative z-10">
                                {fetchingHistory ? (
                                    <div className="flex flex-col items-center justify-center gap-8">
                                        ...
                                        <span className="text-base not-italic opacity-80 font-black uppercase tracking-[0.3em] text-accent animate-pulse">Extracting Intent...</span>
                                    </div>
                                ) : (
                        ...
                        <div className="flex flex-col gap-6 mt-auto pt-8 border-t border-accent/10 relative z-10">
                            <div className="flex items-center justify-between text-[11px] font-black text-text-muted uppercase tracking-widest">
                                <span>AI Confidence</span>
                                <span className="text-accent bg-accent/10 px-4 py-1.5 rounded-2xl border border-accent/20 shadow-sm font-black">94% Precision</span>
                            </div>
            ...
            <section className="pt-6">
                <div className="flex flex-col lg:flex-row justify-between items-center bg-surface/40 border border-border-dim/30 rounded-[3rem] p-10 lg:p-14 gap-12 shadow-xl relative overflow-hidden group backdrop-blur-md">
                    ...
                    <div className="flex flex-col md:flex-row items-center gap-12 relative z-10 text-center md:text-left">
                        ...
                        <div className="flex flex-col gap-2">
                            <h3 className="text-2xl font-black text-text-primary tracking-tighter">Market Intelligence Ready</h3>
                            <p className="text-lg text-text-muted opacity-70 max-w-xl font-medium">Ready to transition from analysis to action. Locate the high-value conversations now.</p>
                        </div>
                    </div>
